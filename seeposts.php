...
<!-- seeposts -->
        ...
        ?>
          <?php 
            $sql="SELECT * FROM foods WHERE status = 1 ORDER BY ID DESC";
        
            if(isset($_GET['CategoryID'])){
                $catID = $_GET['CategoryID'];
                $sql="SELECT * FROM foods WHERE category_id=$catID and status = 1";  
            }
          ...
          ?>
        <!-- Blog begin -->
        <img src="<?php echo $image_detail; ?>" alt="1920x250" class="d-none d-sm-none d-md-none d-lg-block d-xl-block h-250px">
        <!-- Blog end -->
        ...
        <div class="container mt35">
            <div class="row pb50">
                    ...
                    <div class="mt35 pb35"> 
                        ...
                        <div class="row">
                            ...
                            <div class="col-10 pt25">
                                <h3><?php echo $name;?></h3>
                                <p><?php echo mb_substr($description,0,255) . '...';?></p>
                                <div class="row bb-lightgrey bt-lightgrey">
                                    <div class="col-6 pt10 pb10">
                                        <a href="detail.php?id=<?php echo $id;?>" class="btn btn-warning text-uppercase fs-14">
                                            read more
                                        </a>
                                    </div>
                ...
                <!-- Pagination -->
                <div class="mt35 pb35">
                    <a href="#" class="btn btn-warning pl25 pr25 brad-27 mt5 mb5"><i class="fa fa-angle-left" aria-hidden="true"></i> next
                    </a>
                    <a href="#" class="btn btn-outline-dark text-dark pl15 pr15 brad-27">1-3</a>
                    <a href="#" class="btn btn-outline-dark text-dark pl15 pr15 brad-27">3-9</a>
                    <a href="#" class="btn btn-outline-dark text-dark pl15 pr15 brad-27">9-12</a>
